...
@Authenticated
@AccumuloUserContext
public class AccumuloControllerColumnNames extends Controller {
  ...
  @Inject
  public AccumuloControllerColumnNames(Config config) throws IOException {
    this.config = config;
  ...
  public Result searchColumnNames(Request req) throws IOException {
