...
import static com.dataprofiler.util.objects.iterators.rowData.v2.Common.LEX_LONG;
import static org.junit.Assert.*;

import com.dataprofiler.test.IntegrationTest;
import com.dataprofiler.util.objects.iterators.rowData.v2.Common;
import com.dataprofiler.util.objects.iterators.rowData.v2.RowAggregator;
import com.dataprofiler.util.objects.iterators.rowData.v2.TermIterator;
...
public class IteratorTest {
  ...
  public void setup() {
    ...
    {
      long id = 0;
      for (Iterator<String> a = cities.iterator(), b = names.iterator(); a.hasNext() && b.hasNext(); ++id) {
  ...
  public void UnionMultipleDocs() throws Throwable {
    ...
    // order dependant, but we know that the "Bill" doc comes before the "Redwood
    // City" doc
